          ...
          <div className="space-y-4">
            <div className="grid grid-cols-3 gap-4">
              ...
              <div className="p-4 bg-amber-50 rounded-lg">
                <p className="text-sm font-medium text-amber-800">Fee Lainnya</p>
                <p className="text-2xl font-bold text-amber-600">Rp 43K</p>
                <p className="text-xs text-amber-600">18% dari total</p>
              </div>
            </div>
          </div>
        </CardContent>
